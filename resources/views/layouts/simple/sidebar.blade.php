        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class='sidebar-list'>
                        <label class='badge badge-light-info'></label><a class='sidebar-link sidebar-title' href='{{route('file.index')}}'>
                            <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                <g>
                                    <g>
                                        <path d='M14.3053 15.45H8.90527' stroke='#130F26' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'></path>
                            ...
                            </svg><span>File</span></a>
                    </li>
                    <li class='sidebar-list'>
                        <label class='badge badge-light-info'></label><a class='sidebar-link sidebar-title' href='{{route('file_join_subject.index')}}'>
                            <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                <g>
                                    <g>
                                        <path d='M14.3053 15.45H8.90527' stroke='#130F26' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'></path>
                            ...
                            </svg><span>FileJoinSubject</span></a>
                    </li>
                    <!-- ADD_ITEM -->
                </ul>
            </div>

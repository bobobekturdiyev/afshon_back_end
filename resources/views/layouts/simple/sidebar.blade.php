<div class="sidebar-wrapper">
    <div>
        <div class="logo-wrapper"><a href="#"><img class="img-fluid for-light"
                                                   src="{{asset('vendor/programmeruz/laravel-creator/images/logo/programmer.png')}}"
        ...
        <div class="logo-icon-wrapper"><a href="#"><img class="img-fluid"
                                                        src="{{'vendor/programmeruz/laravel-creator/images/logo/photo.png'}}"
                                                        alt=""></a></div>
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn"><a href="#"><img class="img-fluid"
                                                          src="{{asset('vendor/programmeruz/laravel-creator/images/logo/photo.png')}}"
                                                          alt=""></a>
                    ...
                    <li class='sidebar-list'>
                        <label class='badge badge-light-info'></label><a class='sidebar-link sidebar-title'
                                                                         href='{{route('file_join_subject.index')}}'>
                            <svg width='24' height='24' viewBox='0 0 24 24' fill='none'
                                 xmlns='http://www.w3.org/2000/svg'>
                                <g>
                                    <g>
